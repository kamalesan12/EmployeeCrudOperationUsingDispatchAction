...
<html:submit property="empsave"><bean:message key="save"/></html:submit><br>
<html:submit property="empupdate"><bean:message key="update"/></html:submit><br>
<html:submit property="empdelete"><bean:message key="delete"/></html:submit><br>
